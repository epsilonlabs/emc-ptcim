# Epsilon-PTC Integrity Modeler Integration
...
In order to run the PTC IM Epsilon driver using 64-bit Java, two PTC IM keys need to be updated in the registry. This is done by running **as administrator** this [.reg](/plugins/org.eclipse.epsilon.emc.ptcim.com4j/Files/ptc64bit.reg) file (right click -> Save link as ...).
